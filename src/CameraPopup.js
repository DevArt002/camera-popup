...
class CameraPopup extends React.Component {
  ...
  render() {
    ...
    const padding = window.innerWidth > 480 ? 20 : 8;
    const sizeOfBackground = {
      height: cameraHeight + 2 * padding,
      width: cameraWidth + 2 * padding
    };

    return (
      // <div style={this.props.isVisible2} className="modal__wrapper">
      <div style={{ display: "flex" }} className="modal__wrapper">
        <div className="modal__show camera-box" ref={this.modalWrapper}>
          <img
            ...
            <div className="camera-container" style={sizeOfCanvas}>
              ...
              {this.state.isCameraErr && (
                <p className="camera-error">
                  No Camera Device Accessible. Please try to connect your camera
          ...
          {this.state.dataUri && (
            <div className="camera-bottom-section confirm-btn-section">
        ...
        <div
          className="modal__show popup-background"
          style={sizeOfBackground}
        ></div>
      </div>
    );
  }
